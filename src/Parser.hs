...
happyExpList = Happy_Data_Array.listArray (0,43) ([1104,32906,15,17664,2208,33016,20514,35332,4416,552,190,4,4096,512,64,49166,1,0
	])
...
action_12 (8) = happyShift action_9
