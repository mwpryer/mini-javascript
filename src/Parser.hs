...
happyExpList = Happy_Data_Array.listArray (0,58) ([17520,32,128,61440,1,0,7168,14353,34,190,49152,33041,547,1095,2190,4380,128,17520,16384,32768,0,32769,3,7,16384,28703,68,124,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","var","id","num","';'","'='","'+'","'-'","'*'","'/'","'**'","'('","')'","%eof"]
